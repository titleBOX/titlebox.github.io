...
[iscript]
//---シーン毎初期設定---
tf.nowks = 'sq04_movie.ks'; //現在のファイル名----------書き換え 1/6
...
@font color=0x9a8d88
お口もほぐれた所で今日はこの辺にしておくか[p]
明日のステージで上位に入ったらた～っぷりご褒美あげるからな[p]
...
*sq5s1
[clearstack][initialize drama=true]
[movie storage="05-01-01a_0501.webm" skip="true"]
[movie storage="TokimekiRocket.webm" skip="true"]
@layopt layer=message0 visible=true
@spike type=0

地下アイドルの得票トーナメント「地下アイドルバトルロワイヤル！」[p]
この日ホチカは[l]過去最高の得票数をゲットし準優勝を果たしたのだった！[p]

@jump storage="sq06_drama.ks"
