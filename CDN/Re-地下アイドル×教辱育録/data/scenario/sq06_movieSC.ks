...
[iscript]
//---シーン毎初期設定---
tf.nowks = 'sq06_movieSC.ks'; //現在のファイル名----------書き換え 1/6
...
@font color=0xeeeeee
啊…[wait time="300"]啊…[wait time="300"]呜………[r]
感谢…[wait time="300"]你的指导…[wait time="300"]啊………[p]
...
[wait time="300"]被干得一塌糊涂……[wait time="300"][r]
啊…我是色色的偶像……[wait time="300"]真对不起……[p]
