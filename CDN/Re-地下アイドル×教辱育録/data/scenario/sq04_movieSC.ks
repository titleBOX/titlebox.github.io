...
[iscript]
//---シーン毎初期設定---
tf.nowks = 'sq04_movieSC.ks'; //現在のファイル名----------書き換え 1/6
...
*sq5s1
[clearstack][initialize drama=true]
[movie storage="05-01-01a_0501SC.webm" skip="true"]
[movie storage="TokimekiRocket.webm" skip="true"]
@layopt layer=message0 visible=true
@spike type=0

地下偶像的投票比赛「地下偶仆大乱斗！」[p]
这天，[l]帆千佳的得票是史上最高，获得了第二名。[p]

@jump storage="sq06_dramaSC.ks"
