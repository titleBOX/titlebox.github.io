...
[iscript]
//---シーン毎初期設定---
tf.nowks = 'sq06_movieTC.ks'; //現在のファイル名----------書き換え 1/6
...
@font color=0xeeeeee
啊…[wait time="300"]啊……[wait time="300"]嗚……[r]
感謝……[wait time="300"]你的指導……[wait time="300"]啊………[p]
...
哈…哈……[wait time="300"]帆千佳………[wait time="300"]今天也……哈……
[wait time="300"]被幹得一塌糊塗……[wait time="300"][r]
啊…我是色色的偶像………[wait time="300"]真對不起……[p]
